...
!==============================================================================
!> Graphviz output module
!> 
!> Module for VTK output of different data structures. 
!> The routines perform ascii output of datasets see 
!>  http://www.graphviz.org/content/output-formats
!> for details
Module cel_graphvizioio_module
...
contains
  ...
  subroutine write_vtk_coo_matrix(cols, rows, values,  filename, init)
    ...
    integer(kind=rk)   , Dimension(:)          , intent(in) :: cols
    integer(kind=rk)   , Dimension(:)          , intent(in) :: rows
